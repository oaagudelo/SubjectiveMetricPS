function  hist_f6( ALL_PS_D ,ALL_PS, ALL_MS)
...
T_P = {'PD1','PD2','PD3','PD4','PD5','PD6','PD7'};
for k=1:1
    for p=1:7
        figure;
        for f=1:F
    ...
    print(sprintf(['Outputs/Histogram6_' T_S{k} '_' T_P{p} '.pdf']),'-dpdf','-fillpage');
    close
    end
end
end