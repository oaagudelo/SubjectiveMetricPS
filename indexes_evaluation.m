...
%           Q2n_index:          Q2n index.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [Q_index, SAM_index, ERGAS_index, sCC, Q2n_index, D_lambda_index,D_s_index, QNR_index, Qdis_index, Qdnor_index, Qdcor_index, Qniqe_index] = indexes_evaluation(I_F,I_GT,I_MS,I_PAN,sensor,ratio)
...
[QNR_index,D_lambda_index,D_s_index] = QNR(I_F,I_MS,I_PAN,sensor,ratio);
load('pristineModel.mat')
Qdis_index = Qdis(I_F,pristineModel,'norcol');
Qdnor_index = Qdis(I_F,pristineModelN,'normal');
Qdcor_index = Qdis(I_F,pristineModelC,'color');
load('prisparam_NIQE.mat')
Qniqe_index=Q_NIQE(I_F,prisparam_NIQE);
cd ..
